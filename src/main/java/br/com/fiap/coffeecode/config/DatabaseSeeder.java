...
public class DatabaseSeeder implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Pedido p1 = new Pedido(1l, new BigDecimal(10),
                LocalDateTime.parse("2023-03-07 09:52:33", DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss")), 1,
                "João", true);
        Pedido p2 = new Pedido(2l, new BigDecimal(13),
                LocalDateTime.parse("2023-03-07 10:08:46", DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss")), 2,
                "Maria", false);
